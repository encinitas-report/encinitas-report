...
const PAGES = [
  ...
  { id:"intelhub", label:"Intel Hub", icon:"\u{1F9E0}" },
      ...
      <nav className="glass-nav" style={{
        ...
        <div onClick={()=>nav("dash")} style={{ display:"flex", alignItems:"center", gap:10, cursor:"pointer", userSelect:"none" }}>
          ...
          <div>
            ...
            <div style={{ fontSize:8, color:T.muted, fontWeight:600, letterSpacing:"0.5px" }}>David Rose · HomeSmart Realty West \u00b7 DRE# 02168977</div>
          </div>
        </div>
      ...
      {mob && (
        <div className="mob-menu" style={{
          ...
          <div style={{ marginTop:24, padding:"16px 0", borderTop:`1px solid ${T.border}` }}>
            <div style={{ fontSize:12, fontWeight:700, color:T.brand }}>David Rose · HomeSmart Realty West</div>
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:8 }}>
            <div style={{ display:"flex", alignItems:"center", gap:8 }}>
              ...
              <div>
                ...
                <span style={{ fontSize:11, color:T.muted, marginLeft:8 }}>David Rose · HomeSmart Realty West \u00b7 DRE# 02168977</span>
              </div>
            </div>
