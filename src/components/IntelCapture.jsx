...
function detectNeighborhood(addr) {
  ...
  /* Street/landmark heuristics for Encinitas neighborhoods */
  ...
  if (a.includes("92024")) return "old-encinitas"; /* default for 92024 */
...
/* ═══════════════════════════════════════════
   ...
   Shows preview of personalized intel,
   requires email to get the full report
   ═══════════════════════════════════════════ */
  ...
  return (
    <div style={{
      ...
      <div className="anim-scale" onClick={e=>e.stopPropagation()} style={{
        ...
        {/* Step: Preview (show teaser data) */}
        {step === "preview" && (
          <div style={{padding:"20px 28px 28px"}}>
            {report ? (
              <>
                {/* Teaser grid — show enough to hook, blur the rest */}
              ...
              /* No neighborhood match — still capture the lead */
        ...
        {step === "success" && (
          <div style={{padding:"32px 28px",textAlign:"center"}}>
            ...
            {/* Show unlocked data immediately */}
            {report && (
