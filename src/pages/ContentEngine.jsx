...
function EngineInner({onLock}) {
  ...
  const soldScript = hSales.length > 0 ? (() => {
    ...
    return [
      ...
      {h:"📣 CTA", b:`Analysis on every sale → TheEncinitasReport.com. HomeSmart Realty West, DRE# 02168977.`},
    ];
  ...
  const buyerScript = (() => {
    ...
    return [
      ...
      {h:"📣 CTA", b:`theencinitasreport.com for neighborhood comparisons. DM for free buyer strategy. HomeSmart Realty West · DRE# 02168977.`},
    ];
  })();
