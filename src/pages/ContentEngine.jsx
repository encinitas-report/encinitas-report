...
function EngineInner({onLock}) {
  ...
  const soldScript = hSales.length > 0 ? (() => {
    ...
    return [
      ...
      {h:"📣 CTA", b:`Analysis on every sale → TheEncinitasReport.com. David Rose · HomeSmart Realty West, DRE# 02168977.`},
    ];
  ...
  const buyerScript = (() => {
    ...
    return [
      ...
      {h:"📣 CTA", b:`theencinitasreport.com for neighborhood comparisons. DM for free buyer strategy. David Rose · HomeSmart Realty West · DRE# 02168977.`},
    ];
  })();
